...
import com.bruno13palhano.data.repository.favorite.DefaultFavoriteComicsRepository
import com.bruno13palhano.data.repository.favorite.FavoriteComicsRepository
import dagger.Binds
...
@Qualifier
annotation class FavoriteComicsRep
...
internal abstract class RepositoryModule {
    @FavoriteComicsRep
    @Binds
    abstract fun bindFavoriteComicsRepository(favoriteComicsRepository: DefaultFavoriteComicsRepository): FavoriteComicsRepository
